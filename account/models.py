...
ACCOUNT_STATUS=(('active','Active'),('in-active','In-active'),('pending','Pending'))
MARITAL_STATUS=(('married','Married'),('single','Single'),('other','Other'))
GENDER=(('male','Male'),('female','Female'),('other','Other'))
NATIONALITY=(('india','India'),('nigeria','Nigeria'),('united_kingdom','United_kingdom'))
IDENTITY_TYPE=(('national_id_card','National ID Card'),('drivers_licence','Drives Licence'),('international_passport','International Passport'))
...
class Account(models.Model):
    ...
    account_id=ShortUUIDField(unique=True,length=7,max_length=25,prefix="ViP",alphabet='1234567890')
